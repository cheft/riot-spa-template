var browserify, coffee, gulp, ip, preprocess, rename, riot, server, sleet, uglify;
...
gulp.task('build', function() {
  ...
  return gulp.src('demo/scripts/main.js').pipe(browserify()).pipe(rename('app.js')).pipe(gulp.dest('demo/scripts'));
});
